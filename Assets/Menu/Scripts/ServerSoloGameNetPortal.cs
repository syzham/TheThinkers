...
{
    public class ServerSoloGameNetPortal : MonoBehaviour
    {
        [Header("Settings")]
        [SerializeField] private int maxPlayers = 4;

        public static ServerSoloGameNetPortal Instance => instance;
        private static ServerSoloGameNetPortal instance;
